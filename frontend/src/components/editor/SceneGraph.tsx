...
import { ChevronRight, ChevronDown, Box, Layers, FolderPlus, GripVertical, Pencil, Download } from "lucide-react"
...
export function SceneGraph() {
    const { sceneGraph, selectedNodeIds, toggleNodeSelection, groupNodes, scene } = useAppStore()
